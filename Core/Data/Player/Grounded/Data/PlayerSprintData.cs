...
public class PlayerSprintData 
{
    ...
    [field: SerializeField][field: Range(0, 1f)] public float SmoothingWobbleFactor  { get; private set; } = 0.006f;
    [field: SerializeField][field: Range(0, 2f)] public float SmoothingWobblePositionFactor  { get; private set; } = 0.09f;
    [field: SerializeField][field: Range(0, 15f)] public float SmoothingWobblePositionSpeed  { get; private set; } = 10f;
