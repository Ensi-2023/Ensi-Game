...
public class PlayerWalkData 
{
    ...
    [field: SerializeField][field: Range(0, 1f)] public float SmoothingWobblePositionFactor  { get; private set; } = 0.02f;
    [field: SerializeField][field: Range(0, 10f)] public float SmoothingWobblePositionSpeed  { get; private set; } = 3f;
